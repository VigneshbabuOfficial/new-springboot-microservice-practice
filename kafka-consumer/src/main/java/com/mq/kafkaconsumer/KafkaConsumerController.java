...
public class KafkaConsumerController {
	...
	Logger logger = Logger.getLogger("KafkaConsumerController");
	...
	@KafkaListener(groupId = "group-2", topics = "topic-2", containerFactory = "kafkaObjectNodeListenerContainerFactory")
	...
	public List<ObjectNode> getAllJsonMsgs() {
		logger.info(" getAllJsonMsgs - jsonMessages =" + jsonMessages);
		return jsonMessages;
	}
}
