...
public class KafkaConsumerConfig {
	...
	// config for json data - ObjectNode
	@Bean
	public ConsumerFactory<String, ObjectNode> objectNodeConsumerFactory() {
		...
		configs.put(ConsumerConfig.GROUP_ID_CONFIG, "topic-2");
		return new DefaultKafkaConsumerFactory<>(configs, new StringDeserializer(),
				new JsonDeserializer<>(ObjectNode.class));
	}

	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, ObjectNode> kafkaObjectNodeListenerContainerFactory() {
